...
import at.ac.tuwien.sbc.g06.robotbakery.xvsm.service.XVSMUIService;
...
public class XVSMBakeryStartUp extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		DashboardInitializer.initializeDashboard(primaryStage, bakery, new XVSMUIService(server));
